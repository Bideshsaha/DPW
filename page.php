...
<?php
        ...
        $is_video_class = $current_page_slug == 'video' ? 'banner' : '' ;
...
<div class="page-contains">
    ...
    <div class="cpost <?php echo $is_banner_class , $is_video_class; ?>" >
        <?php
        ...
        ?>
            <div class="card">
                <iframe width="853" height="480" src="<?php echo get_the_content();?>" title="" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
